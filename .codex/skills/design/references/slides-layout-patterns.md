...
Pick a layout by slide goal, then adapt the grid and motion to the content:

- opening or first impression -> Title Slide, Big Number Hero
- pain or risk -> Problem Statement, Comparison Table
- explanation or feature summary -> Feature Grid, Two Column Split
- evidence or progress -> Metrics Dashboard, Timeline Flow
- conversion -> CTA Closing, Quote Testimonial
