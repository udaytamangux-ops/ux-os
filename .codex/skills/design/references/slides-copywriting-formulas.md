...
Match the audience emotion first, then pick the formula that moves the slide forward:

- curiosity -> Hook, AIDA
- frustration -> PAS, Cost of Inaction
- trust -> Proof Stack, Testimonial
- confidence -> FAB, Value Stack
- urgency -> AIDA, CTA, Scarcity
