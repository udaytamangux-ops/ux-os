...
Choose the deck structure that matches the job to be done:

- fundraising -> YC Seed Deck, Series A
- sales motion -> Sales Pitch, Product Demo
- internal alignment -> QBR, Team All-Hands
- public speaking -> Conference Talk, Workshop
- proof and comparison -> Case Study, Competitive Analysis
