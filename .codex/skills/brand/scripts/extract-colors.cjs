 ...
 *
 * For full color extraction from images, use ImageMagick or another image-analysis workflow.
 *
 * Usage:
 ...
 *
 * Integration:
 *   For image color analysis, use ImageMagick or another image-analysis tool
...
function main() {
  ...
  const result = {
    ...
    instructions: [
      ...
      "",
      "2. Or use any image-analysis workflow that can return the 10 most dominant hex colors",
      "",
      "3. Then compare extracted colors against the brand palette",
    ],
    complianceCheck: {
      threshold: 50,
      description:
