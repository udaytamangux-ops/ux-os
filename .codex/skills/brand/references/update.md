...
```bash
node C:\Users\ktang\.codex\skills\brand\scripts\sync-brand-to-tokens.cjs
node <path-to-brand-skill>/scripts/sync-brand-to-tokens.cjs
```
...
node C:\Users\ktang\.codex\skills\brand\scripts\inject-brand-context.cjs --json
node <path-to-brand-skill>/scripts/inject-brand-context.cjs --json
